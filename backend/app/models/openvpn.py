...
class OpenVpnServer(Base):
    ...
    vpn_type = Column(String(32), default="openvpn", nullable=False, comment="VPN类型：openvpn/wireguard")
    ...
    wg_interface = Column(String(64), nullable=True, comment="WireGuard接口名称")
    wg_network_cidr = Column(String(64), nullable=True, comment="WireGuard客户端网段")
    wg_dns = Column(String(255), nullable=True, comment="WireGuard客户端DNS")
    wg_allowed_ips = Column(String(255), nullable=True, comment="WireGuard客户端AllowedIPs")
    wg_persistent_keepalive = Column(Integer, nullable=True, comment="WireGuard PersistentKeepalive")
    wg_public_key = Column(String(128), nullable=True, comment="WireGuard服务器公钥")
...
class OpenVpnAccount(Base):
    ...
    wg_client_private_key = Column(String(128), nullable=True, comment="WireGuard客户端私钥")
    wg_client_public_key = Column(String(128), nullable=True, comment="WireGuard客户端公钥")
    wg_client_address = Column(String(64), nullable=True, comment="WireGuard客户端地址")
    remark = Column(Text, nullable=True, comment="备注")
    created_by = Column(Integer, nullable=True, comment="创建人ID")
    created_at = Column(DateTime, default=datetime.utcnow, nullable=False, comment="创建时间")
    updated_by = Column(Integer, nullable=True, comment="修改人ID")
